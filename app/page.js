...
<div className='flex justify-around w-full p-4'>
      <div className='flex flex-col w-[50%]'>
        <div className="div1">
          <h1 className='text-5xl font-bold text-white py-2 m-2'>Login into Your Account</h1>
        </div>

        <div className="text-white py-2 m-2 inline">
          NOT an user ?<a className='text-[#3E43BD] font-bold p-1' href="/register">Register</a>
        </div>
        ...
        <div className="w-[100%] mx-auto">
          <input
            ...
            className="form-input w-[90%]  text-black rounded-[15px] p-4 m-4 "
